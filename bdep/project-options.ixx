...
namespace bdep
{
  ...
  config_type (const string& x)
  {
    this->config_type_ = x;
  }

  inline bool configuration_add_options::
  config_type_specified () const
  {
    return this->config_type_specified_;
  }

  inline void configuration_add_options::
  config_type_specified (bool x)
  {
    this->config_type_specified_ = x;
  }
