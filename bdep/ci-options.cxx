...
namespace bdep
{
  ...
  print_usage (::std::ostream& os, ::bdep::cli::usage_para p)
  {
    ...
    os << std::endl
       ...
       << "                         breakpoint. Valid breakpoint values are \033[1merror\033[0m (stop" << ::std::endl
       << "                         after first error), \033[1mwarning\033[0m (stop after first" << ::std::endl
    ...
    os << std::endl
       << "\033[1m--build-config\033[0m \033[4mcf\033[0m[/\033[4mtg\033[0m]   Shortcut for the following options sequence:" << ::std::endl
       << ::std::endl
       << "                         \033[1m--override builds:all\033[0m\033[0m" << ::std::endl
       << "                         \033[1m--override build-include:\033[0m\033[4mcf\033[0m[/\033[4mtg\033[0m]\033[0m" << ::std::endl
    ...
    os << std::endl
       ...
       << "                         \033[1msuccess\033[0m. For other recognized outcomes refer to the CI" << ::std::endl
       << "                         service documentation." << ::std::endl;
...
namespace bdep
{
  ...
  print_bdep_ci_usage (::std::ostream& os, ::bdep::cli::usage_para p)
  {
    ...
    os << "\033[1mSYNOPSIS\033[0m" << ::std::endl
       ...
       << "then all the packages initialized in the configurations are submitted. See" << ::std::endl
       ...
       << "\033[1m--builds\033[0m, \033[1m--build-config\033[0m, and \033[1m--build-email\033[0m shortcuts. This is primarily useful" << ::std::endl
       << "for specifying alternative build configurations and/or build notification" << ::std::endl
       << "emails. For example:" << ::std::endl
       << ::std::endl
       << "$ bdep ci --builds gcc" << ::std::endl
       << "$ bdep ci --build-config 'linux*-gcc*'" << ::std::endl
       << ::std::endl
