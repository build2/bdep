...
namespace bdep
{
  ...
  print_bdep_usage (::std::ostream& os, ::bdep::cli::usage_para p)
  {
    ...
    os << "\033[1mEXIT STATUS\033[0m" << ::std::endl
       ...
       << "synchronous mode for project databases. See the description of the" << ::std::endl
       << "\033[1m--sqlite-synchronous\033[0m option in \033[1mbdep-common-options(1)\033[0m for the list of valid" << ::std::endl
       << "values and details on their semantics." << ::std::endl;
