...
namespace bdep
{
  ...
  struct _cli_cmd_new_c_options_map_init
  {
    _cli_cmd_new_c_options_map_init ()
    {
      ...
      &::bdep::cli::thunk< cmd_new_c_options, bool, &cmd_new_c_options::cpp_ >;
  ...
  struct _cli_cmd_new_cxx_options_map_init
  {
    _cli_cmd_new_cxx_options_map_init ()
    {
      ...
      &::bdep::cli::thunk< cmd_new_cxx_options, bool, &cmd_new_cxx_options::c_ >;
    }
  };
  ...
  print_usage (::std::ostream& os, ::bdep::cli::usage_para p)
  {
    ...
    os << std::endl
       ...
       << "                         fragments. Currently only the \033[1mstdout\033[0m redirect to a" << ::std::endl
       << "                         file is supported. For example:" << ::std::endl
       << ::std::endl
       ...
       << "                         may optionally contain substitutions -- variable names" << ::std::endl
       ...
       << "                         if the header/source prefix is split with the combined" << ::std::endl
