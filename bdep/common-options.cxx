...
namespace bdep
{
  ...
  print_usage (::std::ostream& os, ::bdep::cli::usage_para p)
  {
    ...
    os << "\033[1m--sqlite-synchronous\033[0m \033[4mmode\033[0m Synchronous mode for project databases." << ::std::endl;
  ...
  print_long_usage (::std::ostream& os, ::bdep::cli::usage_para p)
  {
    ...
    os << std::endl
       << "\033[1m--sqlite-synchronous\033[0m \033[4mmode\033[0m Synchronous mode for project databases. Valid values" << ::std::endl
       << "                          for this option are \033[1moff\033[0m, \033[1mnormal\033[0m (default), \033[1mfull\033[0m, and" << ::std::endl
       << "                          \033[1mextra\033[0m. See SQLite documentation for details on the" << ::std::endl
       << "                          synchronous modes." << ::std::endl
       << ::std::endl
       << "                          Note that WAL (Write-Ahead Logging) journaling mode" << ::std::endl
       << "                          is used for project databases." << ::std::endl;
