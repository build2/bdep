...
namespace bdep
{
  ...
  print_usage (::std::ostream& os, ::bdep::cli::usage_para p)
  {
    ...
    os << "\033[1mCONFIG SUBCOMMANDS\033[0m" << ::std::endl
       ...
       << ::std::endl
       << "    A configuration also has a type that is specified with the \033[1m--config-type\033[0m" << ::std::endl
       << "    option. If the type is not specified explicitly, then \033[1mtarget\033[0m is assumed." << ::std::endl
       ...
       << "    The \033[1mlink\033[0m subcommand links one build configuration with another by executing" << ::std::endl
       << "    the \033[1mbpkg-cfg-link(1)\033[0m command. See \033[1mbpkg-cfg-create(1)\033[0m for background on" << ::std::endl
  ...
  struct _cli_cmd_config_subcommands_map_init
  {
    _cli_cmd_config_subcommands_map_init ()
    {
      ...
      &::bdep::cli::thunk< cmd_config_subcommands, bool, &cmd_config_subcommands::link_ >;
