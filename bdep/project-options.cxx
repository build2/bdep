...
namespace bdep
{
  ...
  merge (const configuration_add_options& a)
  {
    ...
    if (a.config_type_specified_)
    {
      ::bdep::cli::parser< string>::merge (
        this->config_type_, a.config_type_);
      this->config_type_specified_ = true;
    }
  ...
  print_usage (::std::ostream& os, ::bdep::cli::usage_para p)
  {
    ...
    os << "\033[1m--config-type\033[0m \033[4mtype\033[0m       The type of the configuration being created. By" << ::std::endl
  ...
  fill (::bdep::cli::options& os)
  {
    ...
    //
    {
      ...
      ::bdep::cli::option o ("--config-type", a, false, dv);
      os.push_back (o);
    }
  ...
  struct _cli_configuration_add_options_map_init
  {
    _cli_configuration_add_options_map_init ()
    {
      ...
      &::bdep::cli::thunk< configuration_add_options, string, &configuration_add_options::config_type_,
        &configuration_add_options::config_type_specified_ >;
