...
#error SQLite version 3.53.0 or later expected, override with --sqlite-version ODB compiler option
#endif
...
namespace odb
{
  ...
  query (database& db, const query_base_type& q)
  {
    ...
    std::shared_ptr<odb::view_result_impl<view_type>> r (
      std::make_shared<sqlite::view_result_impl<view_type>> (
        qs, std::move (st), sts, nullptr));
